...
PrintConfigDef::PrintConfigDef()
{
	...
	//ConfigOptionDef fill_pattern_def;
	//fill_pattern_def.type = coEnum;
	//fill_pattern_def.enum_keys_map = ConfigOptionEnum<InfillPattern>::get_enum_values();
	//fill_pattern_def.enum_values.push_back("rectilinear");
	//fill_pattern_def.enum_values.push_back("alignedrectilinear");
	//fill_pattern_def.enum_values.push_back("grid");
	//fill_pattern_def.enum_values.push_back("triangles");
	//fill_pattern_def.enum_values.push_back("stars");
	//fill_pattern_def.enum_values.push_back("cubic");
	//fill_pattern_def.enum_values.push_back("concentric");
	//fill_pattern_def.enum_values.push_back("honeycomb");
	//fill_pattern_def.enum_values.push_back("3dhoneycomb");
	//fill_pattern_def.enum_values.push_back("hilbertcurve");
	//fill_pattern_def.enum_values.push_back("archimedeanchords");
	//fill_pattern_def.enum_values.push_back("octagramspiral");
	//fill_pattern_def.enum_labels.push_back("Rectilinear");
	//fill_pattern_def.enum_labels.push_back("Aligned Rectilinear");
	//fill_pattern_def.enum_labels.push_back("Grid");
	//fill_pattern_def.enum_labels.push_back("Triangles");
	//fill_pattern_def.enum_labels.push_back("Stars");
	//fill_pattern_def.enum_labels.push_back("Cubic");
	//fill_pattern_def.enum_labels.push_back("Concentric");
	//fill_pattern_def.enum_labels.push_back("Honeycomb");
	//fill_pattern_def.enum_labels.push_back("3D Honeycomb");
	//fill_pattern_def.enum_labels.push_back("Hilbert Curve");
	//fill_pattern_def.enum_labels.push_back("Archimedean Chords");
	//fill_pattern_def.enum_labels.push_back("Octagram Spiral");
	//def = this->add("fill_pattern", fill_pattern_def);
	//def->label = "Fill pattern";
	//def->category = "Infill";
	//def->tooltip = "Fill pattern for general low-density infill.";
	//def->cli = "fill-pattern=s";
